...
function Header() {
  ...
  return (
    <>
      <nav>
        <div className="container mx-auto flex items-center justify-between text-white mt-[40px]  "> 
          {/* Logo or Brand Name */}
          <h1 className="text-[40px] text-white font-bold mb-6 xl:mb-0 xxs:text-[25px]">
