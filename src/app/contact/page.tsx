...
function Contact() {
  return (
  <>
    <div className='px-[140px] pb-[30px]'> <Header/></div>
    <div className='bg-white px-[140px] mb-[100px] pb-[80px]'>
...
<Link href={'/'}><button className="bg-pink-600 text-white w-[500px] h-[50px] rounded-[30px] mt-[15px]  text-[20px] hover:bg-pink-700">
  Submit</button></Link>
            </div>
          <Image src="/contact.png" alt="contact" width={700} height={300} className='absolute right-[50px] bottom-[0px]'></Image>
