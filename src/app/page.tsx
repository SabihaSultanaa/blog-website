...
export default function Home() {
  return ( 
    <div className="container mx-auto px-[140px] ">
      <Header/>
      <h1 className="text-[120px] font-extrabold mb-8 text-white py-[50px] mt-[70px] mainhead">  BLOG CENTRAL</h1>
      <h2 className='mt-[70px] text-white text-[26px]'>Recent Blog Post</h2>
      ...
      {/* first map work */}
        ...
        {posts.map((post) => (
          <div key={post.id} className="text-white  w-[600px] absolute">
            ...
            <div className='mt-[15px] w-[400px] text-gray-300'>{post.content1}</div>
          ...
          {sides.map((side) => (
            <section key={side.id} className='  text-white ml-[650px] flex w-[700px]'>
              ...
              <div className='mt-[30px] ml-[20px] w-[250px]'>
                ...
                <p className='w-[250px] mt-[10px]  text-gray-300'>{side.content1}</p>
